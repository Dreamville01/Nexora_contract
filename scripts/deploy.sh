#!/usr/bin/env bash
# scripts/deploy.sh — Deploy Nexora core contract to a Soroban network.
#
# Usage:
...
# ── Paths ─────────────────────────────────────────────────────────────────────
WASM_PATH="target/wasm32v1-none/release/nexora_core.wasm"
OPTIMIZED_WASM_PATH="target/wasm32v1-none/release/nexora_core.wasm"
...
echo "$CONTRACT_ID" > .nexora_contract_id
echo "✅ Contract ID stored in .nexora_contract_id"
